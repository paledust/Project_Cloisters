...
#region Interaction Function
    ...
    public virtual void OnClick(PlayerController player, Vector3 hitPos){isControlling = true;}
    public virtual void OnRelease(PlayerController player){isControlling = false;}
