...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        private void UpdateReflectionCamera(Camera realCamera)
        {
            ...
            if (target != null)
            {
                pos = target.transform.position + Vector3.forward * m_planeOffset;
            ...
            var clipPlane = CameraSpacePlane(_reflectionCamera, pos - Vector3.forward * 0.1f, normal, 1.0f);
        ...
        private void ExecutePlanarReflections(ScriptableRenderContext context, Camera camera)
        {
            ...
            m_renderer.sharedMaterial.SetTexture(_planarReflectionTextureId, _reflectionTexture); // Assign texture to water shader
        }
