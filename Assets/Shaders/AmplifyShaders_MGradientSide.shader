...
Shader "AmplifyShaders/Mesh GradientSide"
{
	Properties
	{
		...
		[HDR]_FrontColor("FrontColor", Color) = (1,1,1)
		_DarkColor("DarkColor", Color) = (1,1,1)
		_BrightColor("BrightColor", Color) = (1,1,1)
		_FrontDir("FrontDir", Vector) = (0,1,0,0)
		_GradientDir("GradientDir", Vector) = (1,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(AmplifyShadersMeshGradientSide)
				UNITY_DEFINE_INSTANCED_PROP(float3, _FrontColor)
				UNITY_DEFINE_INSTANCED_PROP(float, _ShadeMin)
				UNITY_DEFINE_INSTANCED_PROP(float, _ShadeSmooth)
			UNITY_INSTANCING_BUFFER_END(AmplifyShadersMeshGradientSide)
						 ...
						 ) : SV_Target
			{
				...
				float3 _FrontColor_Instance = UNITY_ACCESS_INSTANCED_PROP(AmplifyShadersMeshGradientSide,_FrontColor);
				float _ShadeMin_Instance = UNITY_ACCESS_INSTANCED_PROP(AmplifyShadersMeshGradientSide,_ShadeMin);
				float _ShadeSmooth_Instance = UNITY_ACCESS_INSTANCED_PROP(AmplifyShadersMeshGradientSide,_ShadeSmooth);
				float dotResult32 = dot( _GradientDir , ( input.ase_texcoord4.xyz * _Scaler ) );
...
Node;AmplifyShaderEditor.LerpOp;33;-288,-144;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;23;-848,-528;Inherit;False;InstancedProperty;_FrontColor;FrontColor;2;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;False;0;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.PosVertexDataNode;26;-1856,-96;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;35;-1824,80;Inherit;False;Property;_Scaler;Scaler;7;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;-1664,-16;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DotProductOpNode;12;-2848,128;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
