...
Shader "AmplifyShaders/Mesh Color"
{
	Properties
	{
	...
	LOD 0
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult21 = (float4(tex2DNode4.rgb , tex2DNode4.a));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Color * appendResult21 ).rgb;
				float Alpha = 1;
